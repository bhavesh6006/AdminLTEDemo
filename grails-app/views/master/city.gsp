                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input id="searchByCity" name="searchByCity" type="text" class="form-control border-input" placeholder="City Name">
                        </div>
                    </div>

                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="visibility-hidden">City Name</label>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input id="name" name="name" type="text" class="form-control border-input" placeholder="City Name">
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    var eventHandler = {
        ...
        allEventHandler : function() {
            ...
            handlers.showData.fetchAllCities();
            ...
            $('body')
                    .on('click', '#parentDetailsDataTable tbody tr .cityUpdate', function () {
                        ...
                        common.helperFunction.resetForm($('#parent-form'), parentFormValidate);
                        handlers.ajaxCalls.fetchCityDetailsById(rowData.id);
                    })

                    .on('click', '#parentDetailsDataTable tbody tr .cityDelete', function () {
    ...
    var ajaxCallHandler = {
        ...
        cityCRUD : function() {
            ...
            var url = "<%=request.getContextPath() %>/" + common.URLs.cityCRUD;
        ...
        /**
         * Function used for fetch City details by id
         * @id  - Holds database id of City
         */
        fetchCityDetailsById : function(id) {

            var url = "<%=request.getContextPath() %>/" + common.URLs.fetchCityDetailsById;
            var formData = {};
            formData.id = id;
    ...
    var show = {
        ...
        /**
         * Function used for fetch All City
         */
        fetchAllCities : function() {
            ...
            globalConfig.parentDetailsTable = $('#parentDetailsDataTable').DataTable({
                ...
                "ajax": {
                    "url": "<%=request.getContextPath()%>/" + common.URLs.fetchAllCities,
                    "data": function ( paginationParams ) {

                        var data = {};

                        data.start          = paginationParams.start;
                        data.searchByCity   = $('#searchByCity').val();
                ...
                "columns": [
                    ...
                    {"data": "name", "width": "85%"},
                    {
                        ...
                        "render": function ( data, type, row ) {
                            var returnedData = "<i  class='fa fa-edit text-info dataTableActionMargin cityUpdate cursorHoverHand update' aria-hidden='true' data-toggle='tooltip' data-container='body' title='Edit'></i>" +
                                    "<i  class='fa fa-trash text-danger dataTableActionMargin cityDelete cursorHoverHand update' aria-hidden='true' data-toggle='tooltip' data-container='body' title='Delete'></i>";
    ...
    $(document).ready(function () {
        ...
        common.helperFunction.highLightSideBarMenu("", $('#city'));

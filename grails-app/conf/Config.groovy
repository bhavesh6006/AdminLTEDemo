...
environments {
    ...
    production {
        ...
        grails.config.locations = [
                "file:${userHome}/.grails/${appName}-config-PROD.groovy"]
    }
}
...
// Spring security default redirection after successful login
grails.plugin.springsecurity.successHandler.alwaysUseDefault    = true
grails.plugin.springsecurity.successHandler.defaultTargetUrl    = '/user/home'

// Spring security logout success redirection
